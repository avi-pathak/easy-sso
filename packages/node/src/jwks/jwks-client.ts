...
/**
 * Provider-neutral JWKS client: fetches and caches a JWKS, exposing a
 * jose-compatible key resolver for signature verification.
 *
 ...
 *
 * It is provider-neutral on purpose: Microsoft, Google, and any future OIDC
 * provider share it rather than each reimplementing JWKS fetching/caching.
 */
export class JwksClient {
  private readonly cache: MemoryKeyCache<JSONWebKeySet>;
  private readonly jwksUri: string;

  public constructor(options: JwksClientOptions) {
